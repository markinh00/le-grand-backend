...
def populate_database():
    ...
    admin1 = Admin(name="Maria Souza", email="maria@lojadocookie.com", password="123456")
    admin2 = Admin(name="João Lima", email="joao@lojadocookie.com", password="123456")

    customer1 = Customer(name="Carlos Silva", email="carlos@gmail.com", phone="11999998888", password="123456")
    customer2 = Customer(name="Ana Costa", email="ana@gmail.com", phone="21988887777", password="123456")
